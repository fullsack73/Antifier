...
- `portfolio-optimizer-quant-standard.md`: default promotion still pending; execution costs now reconcile across funding, gross/net paths, and primary metrics.
