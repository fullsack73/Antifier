...
- `portfolio-risk-model-research.md`: fixed risk-parity/momentum blend could not dominate both components.
- `portfolio-optimizer-quant-standard.md`: risk/momentum blend failed; test Ledoit minimum-variance/momentum construction next.
